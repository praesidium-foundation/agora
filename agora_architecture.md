...
**Version 3.8.12** — May 3, 2026 — Comprehensive audit and correction of stale column references in tuition RPC bodies. Full version history at the end of this document.
...
- **Migration 035**: Strategic Plan schemas (three instruments)
- **Migration 036**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 037**: Board Composition + Committees
- **Migration 038**: Org Acronyms registry, Custom KPI registry
- **Migration 039**: Module-to-Account mappings
- **Migration 040**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
