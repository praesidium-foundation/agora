...
**Version 3.8.4** — May 3, 2026 — Tuition-B1.3: Projected Discounts consolidation + section subtotals + accounting parentheses convention. Full version history at the end of this document.
...
tuition_worksheet_scenarios
  ...
  projected_multi_student_discount    numeric(12,2)       -- nullable (v3.8.3 / B1.2). Projection of
                                                          ...
                                                          --   compute_tuition_scenario_kpis is queued for
                                                          --   Tuition-C.
...
- **Migration 029**: Strategic Plan schemas (three instruments)
- **Migration 030**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 031**: Board Composition + Committees
- **Migration 032**: Org Acronyms registry, Custom KPI registry
- **Migration 033**: Module-to-Account mappings
- **Migration 034**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
