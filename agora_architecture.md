...
**Version 3.8.1** — May 2, 2026 — Tuition-A2: schema and lock/unlock workflow RPCs (database-layer realization of the v3.8 architectural keystone). Full version history at the end of this document.
...
- **Migration 027**: Strategic Plan schemas (three instruments)
- **Migration 028**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 029**: Board Composition + Committees
- **Migration 030**: Org Acronyms registry, Custom KPI registry
- **Migration 031**: Module-to-Account mappings
- **Migration 032**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
