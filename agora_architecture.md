...
**Version 3.8.7** — May 3, 2026 — Tuition-C: Stage 1 KPIs (Breakeven Enrollment, Net Education Program Ratio) + expense comparator infrastructure. Full version history at the end of this document.
...
- **Migration 030**: Strategic Plan schemas (three instruments)
- **Migration 031**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 032**: Board Composition + Committees
- **Migration 033**: Org Acronyms registry, Custom KPI registry
- **Migration 034**: Module-to-Account mappings
- **Migration 035**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
