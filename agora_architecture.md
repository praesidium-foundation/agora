...
**Version 3.8.17** — May 4, 2026 — Tuition-B2-final-fixes: drop snapshot reason taxonomy, restore snapshot audit log, Discounts card refinements, table header fixes. Full version history at the end of this document.
...
- **Migration 040**: Strategic Plan schemas (three instruments)
- **Migration 041**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 042**: Board Composition + Committees
- **Migration 043**: Org Acronyms registry, Custom KPI registry
- **Migration 044**: Module-to-Account mappings
- **Migration 045**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
