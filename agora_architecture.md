...
- **Migration 019**: Strategic Plan schemas (three instruments)
- **Migration 020**: Snapshot tables for Tuition, Staffing, Enrollment (Budget snapshots shipped in 011)
- **Migration 021**: Board Composition + Committees
- **Migration 022**: Org Acronyms registry, Custom KPI registry
- **Migration 023**: Module-to-Account mappings
- **Migration 024**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
