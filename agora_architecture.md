...
**Version 3.8.20** — May 4, 2026 — Tuition-CrossModule-KPIs: wire Final Budget and Preliminary Budget KPIs to Tuition data sources via promoted Audit reference snapshot. Full version history at the end of this document.
...
- **Migration 045**: Strategic Plan schemas (three instruments)
- **Migration 046**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 047**: Board Composition + Committees
- **Migration 048**: Org Acronyms registry, Custom KPI registry
- **Migration 049**: Module-to-Account mappings
- **Migration 050**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
