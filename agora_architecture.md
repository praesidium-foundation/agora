...
**Version 3.8.11** — May 3, 2026 — Hotfix for Migration 032's compute_tuition_scenario_kpis column references. Full version history at the end of this document.
...
- **Migration 034**: Strategic Plan schemas (three instruments)
- **Migration 035**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 036**: Board Composition + Committees
- **Migration 037**: Org Acronyms registry, Custom KPI registry
- **Migration 038**: Module-to-Account mappings
- **Migration 039**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
