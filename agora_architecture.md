...
**Version 3.8.22** — May 5, 2026 — Tuition-AuditHotfix: faculty rows can now override Multi-Student Discount. Full version history at the end of this document.
...
- **Migration 046**: Strategic Plan schemas (three instruments)
- **Migration 047**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 048**: Board Composition + Committees
- **Migration 049**: Org Acronyms registry, Custom KPI registry
- **Migration 050**: Module-to-Account mappings
- **Migration 051**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
