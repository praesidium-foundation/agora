...
**Page-break behavior**: only Tier 2 carries `break-inside: avoid`. Applying it to Tier 1 would force every category onto its own page (catastrophic on a 77-line budget); applying it to Tier 3 would break too eagerly. Tier 4 leaves break freely — pure leaf-row breaks read fine.
