...
**Version 3.8.13** — May 3, 2026 — Synthetic test user formally documented as an architectural fixture; Tuition module permissions granted. Full version history at the end of this document.
...
- Stage 2 editing surface — per-family rows, applied tier rate dropdown, Faculty/Other/FA per-family allocation columns, the audit comparison view against the Stage 1 snapshot.
...
- **Migration 036**: Strategic Plan schemas (three instruments)
- **Migration 037**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 038**: Board Composition + Committees
- **Migration 039**: Org Acronyms registry, Custom KPI registry
- **Migration 040**: Module-to-Account mappings
- **Migration 041**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
