...
- **Migration 016**: Strategic Plan schemas (three instruments)
- **Migration 017**: Snapshot tables for Tuition, Staffing, Enrollment (Budget snapshots shipped in 011)
- **Migration 018**: Board Composition + Committees
- **Migration 019**: Org Acronyms registry, Custom KPI registry
- **Migration 020**: Module-to-Account mappings
- **Migration 021**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
