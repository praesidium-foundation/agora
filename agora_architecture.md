...
**Version 3.8.14** — May 3, 2026 — Tuition Stage 2 per-family editor (Tuition-B2a). Full version history at the end of this document.
...
- **Migration 037**: Strategic Plan schemas (three instruments)
- **Migration 038**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 039**: Board Composition + Committees
- **Migration 040**: Org Acronyms registry, Custom KPI registry
- **Migration 041**: Module-to-Account mappings
- **Migration 042**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
