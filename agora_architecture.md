...
**Version 3.8.18** — May 4, 2026 — Tuition-B2-import: bulk family import via XLSX/CSV with staging review. Full version history at the end of this document.
...
- **Migration 042**: Strategic Plan schemas (three instruments)
- **Migration 043**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 044**: Board Composition + Committees
- **Migration 045**: Org Acronyms registry, Custom KPI registry
- **Migration 046**: Module-to-Account mappings
- **Migration 047**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
