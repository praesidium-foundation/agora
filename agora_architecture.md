...
**Version 3.8.15** — May 3, 2026 — Hotfix for Tuition-B2a setup card RPC parameter mismatch + button copy refinement. Full version history at the end of this document.
...
- **Migration 038**: Strategic Plan schemas (three instruments)
- **Migration 039**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 040**: Board Composition + Committees
- **Migration 041**: Org Acronyms registry, Custom KPI registry
- **Migration 042**: Module-to-Account mappings
- **Migration 043**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
