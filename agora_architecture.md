...
**Version 3.8.19** — May 4, 2026 — Tuition-B2-import polish: validation gap fixes + Notes placeholder removal + spelled-out family/student labels. Full version history at the end of this document.
...
- **Migration 043**: Strategic Plan schemas (three instruments)
- **Migration 044**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 045**: Board Composition + Committees
- **Migration 046**: Org Acronyms registry, Custom KPI registry
- **Migration 047**: Module-to-Account mappings
- **Migration 048**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
