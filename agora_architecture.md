...
**Version 3.8.9** — May 3, 2026 — Tuition-B1.6: Tier Rates editability flip — discount-driven per-student rates. Full version history at the end of this document.
...
- **Migration 032**: Strategic Plan schemas (three instruments)
- **Migration 033**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 034**: Board Composition + Committees
- **Migration 035**: Org Acronyms registry, Custom KPI registry
- **Migration 036**: Module-to-Account mappings
- **Migration 037**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
