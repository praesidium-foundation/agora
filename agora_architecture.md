...
**Version 3.8.2** — May 3, 2026 — Tuition-B1 / B1.1: Stage 1 (Tuition Planning) configuration UI plus real-data refinements. Full version history at the end of this document.
...
- **Migration 028**: Strategic Plan schemas (three instruments)
- **Migration 029**: Snapshot tables for Staffing, Enrollment (Budget shipped in 011; Tuition shipped in 023)
- **Migration 030**: Board Composition + Committees
- **Migration 031**: Org Acronyms registry, Custom KPI registry
- **Migration 032**: Module-to-Account mappings
- **Migration 033**: Workflow Configuration UI scaffolding (Phase R2) — depends on the Settings UI work; may add a dedicated `workflow_config` module-permission row
